<template>
  ...
  <el-row :gutter="20">
    <el-col :span="12">
      <div class="dialog-item">合作商名称：{{ form.partnerName }}</div>
    </el-col>
    <el-col :span="12">
      <div class="dialog-item">联系人：{{ form.contactPerson }}</div>
    </el-col>
  </el-row>
  <el-row :gutter="20">
    <el-col :span="12">
      <div class="dialog-item">联系电话：{{ form.contactPhone }}</div>
    </el-col>
    <el-col :span="12">
      <div class="dialog-item">分成比例：{{ form.profitRatio }}%</div>
    </el-col>
  </el-row>
</el-dialog>
  </div>
